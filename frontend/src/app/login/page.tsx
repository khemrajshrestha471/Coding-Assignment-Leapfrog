...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      ...
      const response = await fetch("http://20.197.52.87:4000/api/login/enter", {
        method: "POST",
        headers: {
  ...
  const onSubmitForgotPassword = async (data: ForgotPasswordFormData) => {
    ...
    try {
      ...
      const verifyResponse = await fetch(
        "http://20.197.52.87:4000/api/checkUserEmailPhone/check-user-existence",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const onSubmitResetPassword = async (data: ResetPasswordFormData) => {
    try {
      const resetResponse = await fetch(
        "http://20.197.52.87:4000/api/updatePassword/resetPassword",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",

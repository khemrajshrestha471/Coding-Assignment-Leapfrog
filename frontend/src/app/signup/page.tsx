  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    try {
      const checkExistenceResponse = await fetch(
        "https://leapfrog-note-taking-app-backend-ecaaaccdeteqgues.eastasia-01.azurewebsites.net/api/checkExistence/check-existence",
        {
          method: "POST",
          headers: {
    ...
    try {
      ...
      if (verifyResponse.ok) {
        const registrationResponse = await fetch(
          "https://leapfrog-note-taking-app-backend-ecaaaccdeteqgues.eastasia-01.azurewebsites.net/api/signup/register",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
